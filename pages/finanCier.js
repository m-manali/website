      ...
      <section id="intro" className="container theme-widget item active">
        <div className="row">
         ...
         "margin-left": "21px",
            ...
            Financier are the crucial pillar of the TReDS platform, who come in once
              <br/>the invoices are approved by the buyers.
              <br/>
              <br/>With the flexibility to choose the invoices they want to finance,financiers
              <br/>have the liberty to quote the rate of interest at which they can fund the
              <br/>transaction after assessing the underlying risk involved.
              <br/>
              <br/>
        ...
        >
          <div className="resourcesHeading">
            <p>
              <h2 style={{"font-weight": "650"}}>Buyer Financier</h2>
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="heroImagesfinancier1">
          <div>
            ...
            >
               ...
               Contact us to register with us and fund dreams of small Businesses.
